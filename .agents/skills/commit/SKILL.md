...
- Name the concrete user-visible behavior or technical component in the description. Do not use a milestone, task, or issue label as the primary subject description; use it only in a body when it materially aids traceability.
